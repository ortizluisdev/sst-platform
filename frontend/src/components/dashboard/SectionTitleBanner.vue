...
<template>
  <div
    class="flex flex-wrap items-center justify-between gap-3 rounded-lg bg-[var(--org-primary,#0b1a33)] px-4 py-3 print:hidden sm:px-5"
  >
    <p class="min-w-0 truncate text-sm font-semibold" :class="primaryTextClass.text">{{ title }}</p>
